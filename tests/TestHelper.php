...
$GLOBALS['logger_file_name'] = "test.log";
...
require_once("lib/rest/RestApi.php");
...
if (empty($dbm)) {
    throw new Exception('Unable to connect to Database - TestHelper terminating ...');
}
...
class Test_PHPUnit_Framework_TestCase extends PHPUnit_Framework_TestCase
{
...
require_once 'tests/TestRestApi.php';
