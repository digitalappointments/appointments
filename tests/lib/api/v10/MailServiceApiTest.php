...
require_once("lib/api/v10/MailServiceApi.php");
require_once("lib/services/TrackingService/MailTrackingService.php");

/**
 * @group api
 */
class MailServiceApiTest extends TestRestApi
{

    private $valid_customer = 'validcustomerid';
    private $invalid_customer = 'xyz';

    public function setUp()
    {
        self::$json_encoding = 'auto';
        SystemClassLoader::clearMockInstances();
    }
    ...
    public function testRestApi_email_Send_Success()
    {
        ...
        SystemClassLoader::addMockInstance('JobQueue', $mockJobQueue);
    ...
    /**
     * @covers MailServerviceApi::getSendParameters
     * @covers AuthenticationManager::authenticate
     */
    ...
    public function testRestInputValidation_SetCustomerId_CustomerIdPropagatesAsExpected()
    {
        ...
        /* Set Customer Id on the RestApi Parent Class
    ...
    public function testRestApi_email_tracking_Success()
    {
        ...
        SystemClassLoader::addMockInstance($trackingServiceClassName, $mockTrackingService);
    ...
    {
        $mockAuth = self::getMock('Authentication', array('authenticate'));
        $mockAuth->expects($this->once())
            ->method('authenticate')
            ->will($this->returnValue($isValid));
        SystemClassLoader::addMockInstance('AuthenticationManager', $mockAuth);
    }
